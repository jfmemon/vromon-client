...
const BusDetailsCheckout = () => {
    ...
    const to = busServiceDetails?.to;
    const depurtureTime = busServiceDetails?.depurtureTime;
    const arrivalTime = busServiceDetails?.arrivalTime;
    const price = busServiceDetails?.price;
